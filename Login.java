...
public class Login extends javax.swing.JFrame {
  ...
  public void connect() throws SQLException {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ONLINE EXAM LOGIN PAGE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       int Id = Integer.parseInt(jTextField2.getText());
        ...
        try {
            pst=con.prepareStatement("select *from Users where id=? and fname=? and Role=?");
            pst.setInt(1, Id);
            ...
            new IndexMain(userid,Fname,rol).setVisible(true);
            JOptionPane.showMessageDialog(this, "Successfully ");
            }
            else{
            JOptionPane.showMessageDialog(this, "User Name Or User Id do not match");
            jTextField1.setText("");
            jTextField2.setText("");
