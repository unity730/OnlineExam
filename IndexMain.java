 ...
 * @author HP
 */
public class IndexMain extends javax.swing.JFrame {
    ...
    public IndexMain() {
      ...
      public IndexMain(int userid,String Fname,String rol) {
        initComponents();
        this.nfname=Fname;
        ...
        String UserIdentify=jLabel5.getText();
        ...
        else if(UserIdentify.equals("Teacher")){
          jButton1.setVisible(false);
          jButton4.setVisible(false);
        }
    }
    ...
    private void initComponents() {
        ...
        ViewResultbtn.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ViewResultbtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel1.setText("ONLINE EXAM PORTAL");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(IndexMain.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            // TODO add your handling code here:
            QuestionPart q=new QuestionPart();
            q.setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(IndexMain.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndexMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
